...
class PersonDetections(genpy.Message):
  _md5sum = "b8526b10d4ba6d5b2201045a70a54f2f"
    ...
    try:
      ...
      for val1 in self.persons:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_f.pack(_v2.expression_confidence))
        _v4 = val1.legs
        _v5 = _v4.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v18.expression_confidence,) = _struct_f.unpack(str[start:end])
        _v20 = val1.legs
        _v21 = _v20.header
        start = end
        end += 4
    ...
    try:
      ...
      for val1 in self.persons:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_f.pack(_v34.expression_confidence))
        _v36 = val1.legs
        _v37 = _v36.header
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v50.expression_confidence,) = _struct_f.unpack(str[start:end])
        _v52 = val1.legs
        _v53 = _v52.header
        start = end
        end += 4
