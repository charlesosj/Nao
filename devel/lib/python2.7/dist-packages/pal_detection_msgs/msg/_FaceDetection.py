...
class FaceDetection(genpy.Message):
  _md5sum = "56fd9131cf2d8c76c1c86d8f526f7abd"
...
float32 z"""
  ...
  __slots__ = ['x','y','width','height','eyesLocated','leftEyeX','leftEyeY','rightEyeX','rightEyeY','position','name','confidence','expression','expression_confidence']
  _slot_types = ['int32','int32','int32','int32','bool','int32','int32','int32','int32','geometry_msgs/Point32','string','float32','string','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       x,y,width,height,eyesLocated,leftEyeX,leftEyeY,rightEyeX,rightEyeY,position,name,confidence,expression,expression_confidence
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.expression_confidence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.expression_confidence,) = _struct_f.unpack(str[start:end])
      return self
