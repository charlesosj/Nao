...
bool data"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_i5Bi.pack(_x.secs.data, _x.audio_type.data, _x.left_channel.data, _x.right_channel.data, _x.front_channel.data, _x.rear_channel.data, _x.samplerate.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.secs.data, _x.audio_type.data, _x.left_channel.data, _x.right_channel.data, _x.front_channel.data, _x.rear_channel.data, _x.samplerate.data,) = _struct_i5Bi.unpack(str[start:end])
