...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_if.pack(_x.face_id.data, _x.score_reco.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.face_id.data, _x.score_reco.data,) = _struct_if.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
