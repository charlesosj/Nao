  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.shape_sizey:
        buff.write(_struct_f.pack(val1.data))
      _x = self
      buff.write(_struct_14d.pack(_x.camera_local_pose.position.x, _x.camera_local_pose.position.y, _x.camera_local_pose.position.z, _x.camera_local_pose.orientation.x, _x.camera_local_pose.orientation.y, _x.camera_local_pose.orientation.z, _x.camera_local_pose.orientation.w, _x.camera_world_pose.position.x, _x.camera_world_pose.position.y, _x.camera_world_pose.position.z, _x.camera_world_pose.orientation.x, _x.camera_world_pose.orientation.y, _x.camera_world_pose.orientation.z, _x.camera_world_pose.orientation.w))
