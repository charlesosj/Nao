...
if("TRUE" STREQUAL "TRUE")
  set(naoqi_sensors_py_SOURCE_PREFIX /home/charles/catkin_ws/src/naoqi_bridge/naoqi_sensors_py)
  set(naoqi_sensors_py_DEVEL_PREFIX /home/charles/catkin_ws/devel)
  ...
  set(naoqi_sensors_py_INSTALL_PREFIX /home/charles/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Séverin Lemaignan <severin.lemaignan@epfl.ch>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/charles/catkin_ws/src/naoqi_bridge/naoqi_sensors_py/${idir}'.  Ask the maintainer 'Séverin Lemaignan <severin.lemaignan@epfl.ch>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${naoqi_sensors_py_dep}_FOUND)
      find_package(${naoqi_sensors_py_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${naoqi_sensors_py_dep} REQUIRED ${depend_list})
  endif()
