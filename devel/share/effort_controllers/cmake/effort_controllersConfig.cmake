...
if("TRUE" STREQUAL "TRUE")
  set(effort_controllers_SOURCE_PREFIX /home/charles/catkin_ws/src/ros_controllers/effort_controllers)
  set(effort_controllers_DEVEL_PREFIX /home/charles/catkin_ws/devel)
  ...
  set(effort_controllers_INSTALL_PREFIX /home/charles/catkin_ws/install)
...
if(NOT "/home/charles/catkin_ws/src/ros_controllers/effort_controllers/include " STREQUAL " ")
  set(effort_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/charles/catkin_ws/src/ros_controllers/effort_controllers/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'effort_controllers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'effort_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/charles/catkin_ws/src/ros_controllers/effort_controllers/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
