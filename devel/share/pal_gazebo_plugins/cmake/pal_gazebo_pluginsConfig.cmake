...
if("TRUE" STREQUAL "TRUE")
  set(pal_gazebo_plugins_SOURCE_PREFIX /home/charles/catkin_ws/src/pal_gazebo_plugins)
  set(pal_gazebo_plugins_DEVEL_PREFIX /home/charles/catkin_ws/devel)
  ...
  set(pal_gazebo_plugins_INSTALL_PREFIX /home/charles/catkin_ws/install)
...
if(NOT "/home/charles/catkin_ws/src/pal_gazebo_plugins/include " STREQUAL " ")
  set(pal_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/charles/catkin_ws/src/pal_gazebo_plugins/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pal_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Paul Mathieu <paul.mathieu@pal-robotics.com>, Luca Marchionni <luca.marchionni@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pal_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/charles/catkin_ws/src/pal_gazebo_plugins/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Paul Mathieu <paul.mathieu@pal-robotics.com>, Luca Marchionni <luca.marchionni@pal-robotics.com>' to fix it.")
    endif()
    _list_append_unique(pal_gazebo_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gazebo_ros_range;gazebo_ros_forcetorque;gazebo_pal_hand;gazebo_wifi_ap")
