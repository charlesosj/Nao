...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/charles/catkin_ws/install/${idir}'.  Ask the maintainer 'Séverin Lemaignan <severin.lemaignan@epfl.ch>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
